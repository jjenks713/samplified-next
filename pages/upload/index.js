            ...
            <div className="grid justify-center pt-24 text-white">
                ...
                <form className="w-full max-w-sm">
                    ...
                    <div className="md:flex md:items-center mb-6">
                        ...
                        <div className="md:w-2/3">
                            <input type='number' className="text-theme bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" placeholder="BPM" onChange={(e) => updateBpm(e.target.value)} required/>
                        </div>
                    </div>
                    <div className="md:flex md:items-center mb-6">
                        <div className="md:w-1/3">
