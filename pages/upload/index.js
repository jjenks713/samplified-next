...
export default function Upload() {
    ...
    function submitForm() {
        ...
        //do something
        console.log("Doing something", dataObj)
    }
        ...
        <div className="position absolute top-3 right-8 font-bold">
            ...
            <form onSubmit={submitForm} className="w-full max-w-sm">
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                    <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" placeholder="BPM" onChange={(e) => updateBpm(e.target.value)} />
                    </div>
                </div>
                <div className="md:flex md:items-center mb-6">
                    <div className="md:w-1/3">
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                        <select value={genre} placeholder="Genre" className="bg-gray-200 border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" onChange={(e) => updateGenre(e.target.value)}>
                            {
                                genres.map((genre) => (
                                    <option key={genre}>
                                        {genre}
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                        <select value={loop} placeholder="Loop or One-Shot" className="bg-gray-200 border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" onChange={(e) => updateLoop(e.target.value)}>
                            <option>loop</option>
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                        <select value={instrument} className="bg-gray-200 border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" onChange={(e) => updateInstrument(e.target.value)}>
                            {
